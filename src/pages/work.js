      ...
      <div class="work__inner">
        <article class="work__item">
          ...
          <div class="work__deets">
            ...
            <a href="http://www.industrydenver.com" target="_blank" rel="noopener noreferrer" class="btn">See the site.</a>
          </div>
        </article>
        <article class="work__item">
          <div class="work__image">
          ...
          <div class="work__deets">
            ...
            <a href="http://www.specialolympicsco.org" target="_blank" rel="noopener noreferrer" class="btn">See the site.</a>
          </div>
        </article>
        <article class="work__item">
          <div class="work__image">
          ...
          <div class="work__deets">
            ...
            <a href="http://www.imagebrew.com" target="_blank" rel="noopener noreferrer" class="btn">See the site.</a>
          </div>
        </article>
        <article class="work__item">
          <div class="work__image">
          ...
          <div class="work__deets">
            ...
            <a href="http://www.joearchitect.com" target="_blank" rel="noopener noreferrer" class="btn">See the site.</a>
          </div>
        </article>
        <article class="work__item">
          <div class="work__image">
        ...
        <p class="aligncenter">Don't forget to check out <a href="http://codepen.io/magnificode/">my codepen</a> for more examples of my dev chops!</p>
      </div>
    </section>
  </div>
)