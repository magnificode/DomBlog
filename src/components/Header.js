...
const Header = ({ children }) => (
  <nav className="bg-black-90 db dt-l fixed w-100 border-box pa3 ph5-l">
    <Link className="db dtc-l v-mid mid-gray link dim w-100 w-25-l tc tl-l mb2 mb0-l" to="/" title="Home">
      <Logo width="30" />
    </Link>
    <div className="db f6 dtc-l v-mid w-100 w-75-l tc ttu tr-l">
      <Link to="/about" className="link dim white dib mr3">About</Link>
      <Link to="/work" className="link dim white dib mr3">Work</Link>
      <Link to="/resume" className="link dim white dib">R&eacute;sum&eacute;</Link>
    </div>
