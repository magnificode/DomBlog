...
As I write this, support is one day old: [Firefox 154 shipped both functions yesterday](https://developer.mozilla.org/en-US/docs/Mozilla/Firefox/Releases/154), joining Chrome and Edge 138 from June 2025 and Safari 26.2 from December 2025.

The demo keeps every number in CSS. Add and remove elements to watch widths and hues redistribute, replay the entrance stagger, and deal cards into a fan that re-centers itself. Pretty cool.
